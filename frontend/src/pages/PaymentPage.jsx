  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        ...
        <div className="flex border-b border-gray-200">
          {['UPI', 'Card', 'Net Banking'].map(tab => (
            <button
              ...
              className={`flex-1 py-4 text-sm font-medium transition-colors ${activeTab === tab ? 'text-[#E8521A] border-b-2 border-[#E8521A]' : 'text-gray-500 hover:text-gray-700'}`}
            >
              {tab}
            </button>
          ))}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E8521A] tracking-widest"
                />
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E8521A] bg-white"
                >
        ...
        {/* Footer */}
        <div className="bg-gray-50 py-4 text-center border-t border-gray-100 flex items-center justify-center gap-2 text-sm text-gray-500">
